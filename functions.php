...
function custom_site_info() {
	...
	printf( __( '<div class="address"> %3$s <address>1555 5th Street<br />Lincoln, IL 62656</address></div><div class="copyright">&copy %1$s <a href="%2$s" title="Login">%3$s</a></a></div><div class="credits" rel="author">Site design and developed by <a href="http://dccmarketing.com">DCC Marketing</a></div>', 'logan-county' ), date( 'Y' ), get_admin_url(), get_bloginfo( 'name' ) );
...
/**
 * Returns an SVG based on the URL passed into it
 * 
 * @param 	string 		$url 		A URL
 * @return 	mixed 					The SVGx code
 */
