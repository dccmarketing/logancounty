 ...
 * @return 	string 							modified menu
 */
function logancounty_menu_caret( $item_output, $item, $depth, $args ) {
...
add_filter( 'walker_nav_menu_start_el', 'logancounty_menu_caret', 10, 4 );
...
function logancounty_get_svg( $svg ) {
	...
	switch( $svg ) {
		...
		case 'tourism' 			: $output .= '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" xml:space="preserve" class="tourism" viewBox="0 0 132.7 206.9" enable-background="new 0 0 132.7 206.9"><path d="M99.8 111.4c0.4 5.8-2.6 11.3-5.9 16.7 -0.4-0.4-0.8-0.7-1.1-0.9 -1.5-1.3-5.5-4.6-12.7-8.8 13-2.4 12.9-8.5 13.1-10.8 0.3-5-6.8-9-6.8-9s-6.9-3.2-14.2-7.2c19.9-1.5 16-13.5 14.2-16.2 -3.4-5.5-22-11.3-22.7-11.6 -0.6-0.2-1.4-0.6-1.4-0.6s5.2-1.2 8.3-2.3c14.2-6.5-1.5-14.3-1.5-14.3S49 35 47.4 34C45.3 32.7 48 33 48 33s23.2 2.9 25 3.3c1.8 0.5 2.8-1.1 4-3 3.1-4.9-1.4-4.9-1.4-4.9s-0.7-0.2-7.1-1.5c-6.3-1.3-19.1-8.6-20.1-9.5 -1.1-0.8 0.1-0.5 1.4-0.4 11.2 1.3 14.1-0.3 17-1.8 10.5-7.5-2-14.2-2-14.2L62.2 0c10.3 0 20.6 0 30.9 0 -1.9 10.3 6.9 19.7 6.9 30.7C99.9 38.8 98.8 106.4 99.8 111.4zM24.7 97.9c-1.6 1-2.8 2-3.5 3 -0.9-2.5-1.6-4.9-2.2-5.8 -1.8-3-5.6-6.1-8.2-8.8 -6.1-6.3-3.6-16.9-1.6-23.3 1.5-5.2 11.9-11.5 10.1-20.4 -1.4-7.3-5-11.6 9.1-12.1 17.1-9.7 6.7-19.9-1.7-30.6 9.2 0 18.4 0 27.5 0 3.1 1.6 7.7 4.2 9.8 5.5 5.6 3.3-0.7 3.7-0.7 3.7s-6.3 0.1-12.8-0.6c-6.5-0.7-8.2 2.5-8.6 3.2 -3.5 5.7 5.3 10 11.8 13.8 -12.1-2.1-14.5-0.7-16.1 0.8 -4.2 5 3.4 8.4 3.4 8.4S64.2 48 68.4 50.7c4.1 2.8 1.6 3-1.6 3.9 -3.3 0.9-15.9-1.4-20.5-3 -4.6-1.5-7.1 1.5-6.7 4.8 0.6 4.6 4.3 4.3 5.3 4.5 1 0.3 10.5 2.5 28.8 9.9 18.4 7.4 9.5 12 7.9 12.2C78.6 84.2 67.5 84 56.5 83c-4.9-2.7-8.9-5.1-10.5-6 -5.3-3-14.9-7.1-21.1-6.7 -8.5 0.5-8 6.8-7.6 8.8 1.2 4.2 5.5 6.2 8.7 7.3 10 3.7 22.7 5.8 39.7 5.2 9.7 5.4 17.7 10 17.7 10 14.5 8.2 1.6 8.4-9.2 8.8 -2.
1v17.9c0 0.7 0.4 1 1.2 1h0c0.8 0 1.2-0.3 1.2-1v-15.1l14.4 15.5c0.3 0.3 0.7 0.5 1 0.5h0c0.8 0 1.2-0.3 1.2-1v-17.9C77.1 187.2 76.7 186.9 75.9 186.9zM93.8 186.9c-3.3 0-6.1 1-8.4 2.9 -2.3 1.9-3.5 4.3-3.5 7 0 2.8 1.2 5.1 3.5 7.1 2.3 1.9 5.1 2.9 8.4 2.9h0.1c3.3 0 6-1 8.4-2.9 2.3-2 3.5-4.3 3.5-7.1 0-2.7-1.2-5.1-3.5-7C99.9 187.9 97.1 186.9 93.8 186.9zM100.6 202.5c-1.9 1.6-4.1 2.3-6.7 2.3 -2.6 0-4.9-0.8-6.7-2.3 -1.9-1.6-2.8-3.4-2.8-5.6 0-2.2 0.9-4.1 2.8-5.6 1.9-1.6 4.1-2.3 6.7-2.3 2.6 0 4.9 0.8 6.7 2.3 1.9 1.6 2.8 3.4 2.8 5.6C103.4 199.1 102.4 201 100.6 202.5zM112.5 186.9c-0.8 0-1.2 0.3-1.2 1v18c0 0.7 0.4 1 1.2 1 0.8 0 1.2-0.3 1.2-1v-18C113.6 187.2 113.2 186.9 112.5 186.9zM130.6 196.7c-1.4-1.2-3.1-1.8-5-1.8 -1 0-1.8-0.3-2.5-0.9 -0.7-0.6-1-1.3-1-2.1 0-0.8 0.3-1.5 1-2.1 0.7-0.6 1.6-0.9 2.5-0.9 1 0 1.9 0.3 2.6 1 0.7 0.7 1.2 1 1.5 1 0.3 0 0.6-0.1 0.9-0.3 0.2-0.2 0.4-0.4 0.4-0.7l-0.2-0.5c-0.5-0.8-1.2-1.4-2.2-1.8 -1-0.4-1.9-0.7-3-0.7 -1.6 0-3 0.5-4.2 1.5 -1.2 1-1.7 2.2-1.7 3.5 0 1.4 0.6 2.5 1.7 3.5 1.2 1 2.6 1.5 4.2 1.5 1.3 0 2.4 0.4 3.4 1.2 0.9 0.8 1.4 1.7 1.4 2.8 0 1.1-0.5 2-1.4 2.8 -0.9 0.8-2.1 1.2-3.4 1.2 -1.5 0-2.6-0.4-3.6-1.3 -0.3-0.3-0.5-0.5-0.6-0.7 -0.3-0.3-0.6-0.5-1-0.5 -0.3 0-0.6 0.1-0.9 0.3 -0.3 0.2-0.4 0.4-0.4 0.7l0.2 0.5c0.6 0.9 1.5 1.6 2.6 2.2 1.1 0.5 2.3 0.8 3.6 0.8 2 0 3.6-0.6 5-1.7 1.4-1.2 2.1-2.6 2.1-4.2S132 197.8 130.6 196.7z"/></svg>'; break;
...
function add_svg_to_captions( $caption, $id, $item, $data, $i ) {
	...
	$caption = logancounty_get_svg( 'check' ) . $caption;
...
function logancounty_page_header_image( $pageID ) {
	...
	$image = get_thumbnail_url( $pageID, 'large' );

	if ( ! $image ) {

		$bg_image = get_field( 'default_header_image', $defaultID );
