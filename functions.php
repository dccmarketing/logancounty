 ...
 */
function logancounty_menu_icons( $item_output, $item, $depth, $args ) {
	...
	if ( $host !== parse_url( get_site_url(), PHP_URL_HOST ) ) { 
		...
		$output .= get_icon_by_url( $item->url );

	} else {

		$output .= get_icon_by_pageID( $item->object_id );
...
} // logancounty_menu_icons()

add_filter( 'walker_nav_menu_start_el', 'logancounty_menu_icons', 10, 4 );



/**
 * Gets the appropriate icon based on a URL
 * @param  [type] $url [description]
 * @return [type]      [description]
 */
function get_icon_by_url( $url ) {
	...
	switch( $host ) {
		...
		case 'facebook.com' 	: $output .= get_icon( 'facebook' ); break;
		case 'instagram.com' 	: $output .= get_icon( 'instagram' ); break;
		case 'youtube.com' 		: $output .= get_icon( 'videos' ); break;
 ...
 * @return [type]      [description]
 */
function get_icon_by_pageID( $ID ) {
	...
	switch( $page->post_title ) {
		...
		case 'Calendar' 			: $output .= get_icon( 'calendar' ); break;
		case 'Camping' 				: $output .= get_icon( 'camping' ); break;
		case 'Events & Festivals' 	: $output .= get_icon( 'calendar' ); break;
		case 'Hotels' 				: $output .= get_icon( 'hotel' ); break;
		case 'Maps' 				: $output .= get_icon( 'map' ); break;
		case 'Motels' 				: $output .= get_icon( 'hotel' ); break;
...
/**
 * Returns an SVG icon based on the URL passed into it
 * 
 * @param 	string 		$url 		A URL
 * @return 	mixed 					The SVG icon code
 */
